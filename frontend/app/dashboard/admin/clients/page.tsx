                ...
                <tr key={client.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 text-center">
                    <div className="flex justify-center gap-2">
                      <span className="bg-black text-white px-3 py-1 rounded-full text-[10px] font-bold">
                        Agendamentos
                      </span>
                      <span className="bg-white border border-gray-200 text-gray-600 px-3 py-1 rounded-full text-[10px] font-medium shadow-sm">
                        Logs
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="py-4 text-right pr-2">
                    <div className="flex justify-end">
                      <button 
                        ...
                        className={`w-10 h-5 rounded-full p-1 transition-colors duration-300 ease-in-out relative ${client.status ? 'bg-black' : 'bg-gray-200'}`}
                      >
